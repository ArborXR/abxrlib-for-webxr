...
export declare class iXRLibClient {
    ...
    static GetIXRXXXs<T extends DataObjectBase>(tTypeOfT: any, vpszQueryParameters: Array<[string, string]>, /*OUT*/ ptContainedResponse: iXRXXXContainer<T, PythonDictStrings, false> | null, /*OUT*/ ptResponse: T | null): Promise<iXRResult>;
    ...
    static GetIXRStorage(/*OUT*/ ixrStorage: iXRXXXContainer<iXRStorage, PythonDictStrings, false>): Promise<iXRResult>;
