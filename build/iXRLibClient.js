...
class AuthTokenRequest extends (_b = DataObjectBase_1.DataObjectBase) {
    ...
    constructor() {
        ...
        this.m_dictGeoLocation = new DotNetishTypes_1.iXRDictStrings();
...
class iXRLibClient {
    ...
    static async GetIXRXXXs(tTypeOfT, vpszQueryParameters, /*OUT*/ ptContainedResponse, /*OUT*/ ptResponse) {
        try {
            ...
            if (eCurlRet) {
                ...
                if ((0, iXRLibCoreModel_1.RESTEndpointFromType)(tTypeOfT) === 'storage/config') {
                    try {
    ...
    static async PostAuthenticate(authTokenRequest, rpResponse) {
        var objRequest = new types_1.CurlHttp();
        var eCurlRet;
        var szJSON = (0, DataObjectBase_1.GenerateJson)(authTokenRequest, DataObjectBase_1.DumpCategory.eDumpEverything); // Save a few ns not going with eDumpingJsonForBackend... this is not a database object, no need to exclude fields.
...
;
//# sourceMappingURL=iXRLibClient.js.map